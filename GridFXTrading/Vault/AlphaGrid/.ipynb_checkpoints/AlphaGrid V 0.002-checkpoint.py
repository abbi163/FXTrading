...
void OnTick()
  { 
   ...
   int buyCondition = BuyCondition();
   Comment(StringFormat("Show if buy condition is true :  %G",buyCondition));
   
   int sellCondition = SellCondition();
   Comment(StringFormat("Show if buy condition is true :  %G",sellCondition));
